...
from decouple import config  # Import config to use .env
...
INSTALLED_APPS = [
    ...
    'corsheaders',  # Add this for frontend CORS
]
...
# CHATBOT_RESPONSE_MODEL = config('CHATBOT_RESPONSE_MODEL', default='gpt-3.5-turbo')
